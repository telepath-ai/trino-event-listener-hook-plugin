...
public class EventListenerHookEventListener implements EventListener {
    ...
    public void queryCompleted(final QueryCompletedEvent queryCompletedEvent) {
        JSONObject hookStatistics = new JSONObject()
            ...
            .put("processedInputRows", queryCompletedEvent.getStatistics().getProcessedInputRows())
            .put("physicalInputRows", queryCompletedEvent.getStatistics().getPhysicalInputRows())
            .put("internalNetworkRows", queryCompletedEvent.getStatistics().getInternalNetworkRows())
            .put("outputRows", queryCompletedEvent.getStatistics().getOutputRows())
